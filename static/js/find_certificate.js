    ...
    function find (input) {
        for(var i in batch_volunteers){
            if(String(batch_volunteers[i].unique_key) === input) {
                ...
                batch_volunteer_input.append(batch_volunteer.volunteer__first_name + " " + batch_volunteer.volunteer__surname +
    ...
    function findParticipant (input) {
        for(var i in batch_participants){
            if(String(batch_participants[i].unique_key) === input) {
                ...
                batch_participant_input.append(batch_participant.participant__first_name + " " + batch_participant.participant__surname +
