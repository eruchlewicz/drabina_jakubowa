$(document).ready(function () {
    ...
    function check_if_accommodation_included() {
        if(!with_accommodation) {
            ...
            accommodation.parent().parent().find( "span" ).addClass('hidden');
            accommodation.parent().addClass('hidden');
            $('label[for="id_accommodation"]').parent().addClass('hidden');
        }
        else {
            accommodation = $('#id_accommodation');
            document.getElementById("id_accommodation").selectedIndex = "0";
            accommodation.parent().parent().find( "span" ).removeClass('hidden');
            accommodation.parent().removeClass('hidden');
            $('label[for="id_accommodation"]').parent().removeClass('hidden');
        }
    }
