...
class VolunteerForm(forms.ModelForm):
    ...
    class Meta:
        model = Volunteer
        fields = ['sex', 'pesel', 'age', 'phone_number', 'mother_first_name', 'mother_surname', 'father_first_name',
        ...
        labels = {
            ...
            'mother_first_name': _('Imię matki'),
            'mother_surname': _('Nazwisko panieńskie matki'),
            'father_first_name': _('Imię ojca'),
            'city': _('Miejscowość'),
        ...
        help_texts = {
            ...
            'mother_first_name': 'Zgodnie z wymogami ochrony maloletnich potrzebujemy tych danych w celach kontrolnych.',
            'mother_surname': 'Zgodnie z wymogami ochrony maloletnich potrzebujemy tych danych w celach kontrolnych.',
            'father_first_name': 'Zgodnie z wymogami ochrony maloletnich potrzebujemy tych danych w celach kontrolnych.',
    ...
    def clean(self):
        ...
        cleaned_mother_first_name = cleaned_data.get('mother_first_name')
        cleaned_mother_surname = cleaned_data.get('mother_surname')
        cleaned_father_first_name = cleaned_data.get('father_first_name')
        ...
        if not cleaned_mother_first_name:
            msg = _("Pole jest wymagane.")
            self.errors["mother_first_name"] = self.error_class([msg])

        if not cleaned_mother_surname:
            msg = _("Pole jest wymagane.")
            self.errors["mother_surname"] = self.error_class([msg])

        if not cleaned_father_first_name:
            msg = _("Pole jest wymagane.")
            self.errors["father_first_name"] = self.error_class([msg])
...
class VolunteerEditForm(forms.ModelForm):
    class Meta:
        model = Volunteer
        fields = ["first_name", 'surname', 'email_address', 'sex', 'pesel', 'age', 'phone_number', 'mother_first_name',
                  'mother_surname', 'father_first_name', 'city', 'zip_code', 'address',
