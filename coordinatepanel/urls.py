...
urlpatterns = [
    ...
    url(r'^turnus/(?P<pk>[0-9]+)/wolontariusze/adresy-email/$', views.email_addresses,
    ...
    url(r'^turnus/(?P<pk>[0-9]+)/podopieczni/(?P<participant_id>[0-9]+)/edycja/$', views.edit_participant,
    ...
    url(r'^turnusy/wolontariusze/(?P<pk>[0-9]+)/umowa-pielegniarki.pdf/$',
        login_required(NurseContractPDFView.as_view()), name='nurse_contract'),
    url(r'^turnusy/wolontariusze/(?P<pk>[0-9]+)/umowa-lekarza.pdf/$',
