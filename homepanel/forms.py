...
class ParticipantForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["first_name", 'surname', 'sex', 'pesel', 'phone_number', 'guardian_name', 'guardian_phone_number',
                  ...
                  'drugs', 'communication', 'mental_disability', 'not_need_help', 'wheelchair', 'disabled_hands',
                  'crutches', 'disabled_sight', 'disabled_hearing', 'epilepsy', 'details']
        labels = {
            "first_name": _('Imię'),
            'surname': _('Nazwisko'),
            'sex': _('Płeć'),
            ...
            'drugs': _('Czy przyjmuje leki?'),
            'communication': _('Komunikacja'),
            'mental_disability': _('Niepełnosprawność intelektualna'),
            'not_need_help': _('Nie potrzebuje pomocy przy codziennych czynnościach'),
            'wheelchair': _('Porusza się na wózku'),
            'disabled_hands': _('Niesprawne ręce'),
            'crutches': _('Porusza się o kulach'),
            'disabled_sight': _('Niesprawny wzrok'),
            'disabled_hearing': _('Niesprawny słuch'),
            'epilepsy': _('Możliwe ataki padaczki'),
            'details': _('Uwagi'),
        }
    ...
    def clean(self):
        ...
        if not re.match('^[A-Ża-ż _/]{2,25}[ ][0-9a-ż/]{1,5}$', cleaned_address):
